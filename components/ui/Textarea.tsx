...
export default function Textarea({ label, error, className, ...rest }: Props) {
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <textarea
        className={cn(
          'bg-[rgba(0,212,255,0.03)] border border-[rgba(0,212,255,0.15)] text-[#e8f4f8] px-4 py-3 font-rajdhani text-sm outline-none transition-all duration-300 placeholder:text-[rgba(255,255,255,0.2)] resize-y min-h-[120px]',
